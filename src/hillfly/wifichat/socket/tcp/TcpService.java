	...
	public class SaveFileToDisk extends Thread {
		...
		public void recieveFile() {
			...
			try {
				...
				new File(fileSavePath).getParentFile().mkdirs();
				...
				while (-1 != (readSize = dataInput.read(mBuffer))) {
					...
					t = currentLength * 1.0 / fs.fileSize*100;
					LogUtils.i(TAG, "file 接受：" + t  + "%");
					if (t % 2 <= 0.8) {// 每1%刷新一次
