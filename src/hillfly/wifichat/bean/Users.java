...
public class Users extends Entity implements Parcelable {
	...
	public Users(int age, int avatar, int onlinestate, String nickname,
			String gender, String IMEI, String device, String birthday,
			String constellation, String ip, String logintime) {
		this.mAge = age;
		this.mAvatar = avatar;
